...
public record TaskDto(Guid Id, Guid ProjectId, Guid? ListId, string Title, string? Description, string Priority, string? LabelsJson, Guid? AssigneeId, int Position, DateTime CreatedAt, DateTime? DueDate = null, string IssueType = "Task", string? Epic = null, int? StoryPoints = null, DateTime? StartDate = null, string? Environment = null, Guid? ParentIssueId = null, Guid? SprintId = null, string? WatchersJson = null, string? LinkedIssuesJson = null, int? TimeEstimated = null, int? TimeSpent = null, int? TimeRemaining = null, Guid? TeamId = null, string Status = "To Do", Guid? StatusId = null);
