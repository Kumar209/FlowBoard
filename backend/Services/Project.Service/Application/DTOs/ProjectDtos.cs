...
/// <summary>
/// ProjectDtos - response shapes for Project CQRS. Used by handlers to return clean DTOs instead of entities (avoids EF navigation serialization). Key is prefix like FB-3 for search.
/// </summary>
...
public record ProjectMemberDto(Guid Id, Guid ProjectId, Guid UserId, string Email, string FullName, string Role, DateTime JoinedAt, string? OrgRole = null, string? WorkspaceRole = null);
