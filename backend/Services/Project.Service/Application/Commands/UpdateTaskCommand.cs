...
/// </summary>
public record UpdateTaskCommand(Guid TaskId, string Title, string? Description, string Priority, string? LabelsJson, Guid? AssigneeId, DateTime? DueDate, Guid CallerId, List<string> CallerRoles, string? IssueType = null, string? Epic = null, int? StoryPoints = null, DateTime? StartDate = null, string? Environment = null, Guid? ParentIssueId = null, Guid? SprintId = null, string? WatchersJson = null, string? LinkedIssuesJson = null, int? TimeEstimated = null, int? TimeSpent = null, int? TimeRemaining = null, Guid? TeamId = null, Guid? ListId = null, string? Status = null, Guid? StatusId = null) : IRequest<Result<TaskDto>>;
