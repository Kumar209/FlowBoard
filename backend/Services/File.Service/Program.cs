...
{
    o.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo { Title = "FlowBoard File.Service", Version = "v1", Description = "Cloudinary attachments - POST /api/files/upload" });
