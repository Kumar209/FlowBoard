...
export class ProjectService {
  ...
  updateTask(taskId: string, title: string, description?: string, priority = 'Medium', listId?: string, labelsJson?: string, assigneeId?: string, dueDate?: string, issueType?: string, epic?: string, storyPoints?: number, startDate?: string, taskEnv?: string, parentIssueId?: string, sprintId?: string, watchersJson?: string, linkedIssuesJson?: string, timeEstimated?: number, timeSpent?: number, timeRemaining?: number, teamId?: string, statusId?: string, acceptanceCriteriaJson?: string) {
